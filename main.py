...
The images in the image directory are from Danbooru.
'''
...
from retriever import saveImages
import shutil
...
class PicturesApp(App):
    ...
    def build(self):
        ...
        print "=======DIRECTORIO=======   " + curdir
        for filename in glob(join(curdir, 'images', '*')):
            try:
                # load the image
                print "HEEEEEEEEY::::+*** " + filename
